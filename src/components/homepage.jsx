    ...
    <div className="flex flex-col min-h-screen w-full bg-[#FAE7D5] text-gray-900">
      ...
      <section className="px-4 md:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[
            { title: "Rosie", subtitle: "Rose", img: "src/assets/images/rosie.png" },
            { title: "Dirty Work", subtitle: "Aespa", img: "src/assets/images/dw.png" },
            { title: "Ruby", subtitle: "Jennie", img: "src/assets/images/ruby.png" },
          ].map((item) => (
            <div
              key={item.title}
            ...
            >
              <img src={item.img} alt={item.title} className="rounded-xl w-full" />
...
<section className="px-6 md:px-12 py-10 bg-[#F4D7BA] rounded-2xl mx-4 md:mx-8">
  <div className="flex flex-col md:flex-row items-center md:items-center gap-4 md:gap-10">
    ...
    <div className="w-full md:w-[260px] lg:w-[300px] flex-shrink-0">
      <img
        src="src/assets/images/Vinyl.jpg"
        alt="vinyl setup"
      ...
      <section className="px-4 md:px-8 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[
            { rating: 4.5, text: "The best packaging I've seen — hard and secure!", name: "Shad Gabriel Silverio" },
            { rating: 4.5, text: "Wide variety of great quality records.", name: "Shacel Joy Masaya" },
            { rating: 4.5, text: "Very responsive and easy to talk to.", name: "Maria Faith Ibaldez" },
          ].map((review) => (
            <div
              key={review.name}
